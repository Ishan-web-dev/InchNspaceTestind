...
const PROCESS_HERO_DATA = [
  {
    ...
    content: {
      ...
      description:
        "From the first conversation to the final detail, our process transforms ideas into considered spaces through thoughtful planning, refined design, and uncompromising execution.",
        ...
        <div key={index} className="contents">
          ...
          {hero.background?.image && (
            <div className="absolute top-0 right-0 w-full h-full z-0 pointer-events-none">
              ...
              <div
                className={`w-full h-full bg-cover bg-center ${hero.background.opacity} ${hero.background.scale} transition-transform duration-1000`}
                style={{
          ...
          <div className="relative z-20 max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-20 w-full">
            ...
            >
              ...
              {hero.content?.title && (
                <motion.h1
                  className="font-['Playfair_Display'] text-5xl sm:text-7xl md:text-8xl lg:text-[110px] leading-none text-[#eee0d6] tracking-tight mb-8 font-normal"
              ...
              <div className="max-w-2xl space-y-8">
                {hero.content?.description && (
                  <motion.p
                    className="font-['Montserrat'] text-base sm:text-lg md:text-xl text-[#c4c7c7] font-light leading-relaxed"
          ...
          {hero.scrollIndicator?.label && (
            <motion.div
              className="absolute bottom-8 right-6 md:right-16 hidden sm:flex items-center gap-4 opacity-60 hover:opacity-100 transition-opacity duration-300"
